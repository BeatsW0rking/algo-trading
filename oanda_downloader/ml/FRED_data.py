...
def setup_FRED():
    global API_KEY
    global PROJECT
    with open("../../secret/config-FRED.json", "r") as file:
...
#%% Create Staionary Series - Skipped for now...
...
#%% Fit Models Using Nueral Forecast Model TFT
...
# %% Generate 1 day ahead predicitions
